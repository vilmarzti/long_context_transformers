...
def main():
    ...
    # Create Model
    config = CompressiveTransformerConfig(4, 10, vocab_size=tokenizer.vocab_size, n_layer=1, return_dict=True, output_hidden_states=True, cutoffs=[1000, 5000, 15000])
    ...
    train_loader, valid_loader, _ = get_dataloader(tokenizer, 2, 200)
